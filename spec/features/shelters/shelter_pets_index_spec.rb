...
RSpec.describe "Shelter Pets Index page" do
  it "allows visitors to see list of pets and their info from a specific shelter" do
    ...
    cat2 = Pet.create!(name: "Smudge", age: 6, sex: "female", status: false, image: "https://www.aljazeera.com/mritems/imagecache/mbdxxlarge/mritems/Images/2020/4/13/ecab8c7af42a439d9043b0ade6e1f05b_18.jpg", shelter_id: shelter_2.id)
